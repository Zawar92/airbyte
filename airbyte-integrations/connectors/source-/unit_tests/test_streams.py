...
import pytest
from source_.source import Stream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(Stream, "path", "v0/example_endpoint")
    mocker.patch.object(Stream, "primary_key", "test_primary_key")
    mocker.patch.object(Stream, "__abstractmethods__", set())
